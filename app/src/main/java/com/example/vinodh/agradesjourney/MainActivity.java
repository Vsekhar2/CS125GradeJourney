package com.example.vinodh.agradesjourney;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageCharacterLeft = getResources().getDrawable(R.drawable.character);
        imageCharacterRight = getResources().getDrawable(R.drawable.character);
